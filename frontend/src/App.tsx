...
function App() {
  ...
  async function confirmInitializeVault() {
    try {
      setBusy(true)
  ...
  return (
    <div className="app">
      ...
      <ConfirmDialog
        ...
        message="This will create a new encrypted vault. Your master password cannot be recovered if forgotten. This action cannot be undone."
        confirmLabel="Initialize"
        tone="danger"
        onConfirm={() => void confirmInitializeVault()}
